  ...
  return (
    <Reveal>
      <div className="relative group overflow-hidden rounded-[3rem] border border-[var(--border)] bg-[var(--surface)] backdrop-blur-xl md:backdrop-blur-3xl p-10 md:p-16 shadow-[var(--card-shadow)]">
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[var(--accent-bright)]/10 blur-[130px] rounded-full -translate-y-1/2 translate-x-1/2 pointer-events-none group-hover:bg-[var(--accent-bright)]/20 transition-colors duration-1000" />
        <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-[var(--accent-glow)]/10 blur-[100px] rounded-full translate-y-1/2 -translate-x-1/2 pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex flex-col sm:flex-row md:flex-col gap-4 w-full md:w-auto">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-[var(--accent-bright)]/20 to-[var(--accent-glow)]/20 opacity-0 group-hover/btn:opacity-100 transition-opacity" />
        ...
        <div className="mt-16 pt-10 border-t border-white/5 flex flex-wrap gap-10 opacity-30">
           <div className="flex items-center gap-3">
              <ShieldCheck size={16} className="text-[var(--accent-bright)]" />
