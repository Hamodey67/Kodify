    ...
    <div className='rounded-2xl border border-white/10 bg-white/[0.03] p-5'>
      <div className='flex flex-col gap-2'>
        ...
        <div className='mt-2 flex flex-wrap items-center gap-2 text-xs text-white/60'>
          <span className='rounded-full bg-white/10 px-3 py-1'>{scoreLabel}</span>
          <span className='rounded-full bg-white/10 px-3 py-1'>🔥 {streakLabel}</span>
        </div>
        ...
        <div className='mt-4'>
          ...
          <ul className='mt-2 list-disc space-y-1 ps-5 text-sm text-white/75'>
        ...
        <button
          type='button'
          onClick={onNext}
          className='mt-5 w-full rounded-xl bg-white/10 px-4 py-2 text-sm font-semibold text-white hover:bg-white/15 active:scale-[0.99]'
        >
          {nextLabel}
        </button>
      </div>
