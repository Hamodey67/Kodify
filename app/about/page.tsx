...
const content = {
  ...
  ku: {
    badge: "پوختەیەکی خێرا",
    title: "دەربارەی ئێمە",
    subtitle:
      "ئێمە تیمێکی پێشەنگین لە KODIFY — خزمەتگوزارییەکانی گەشەپێدانی سۆفتوێر، دیزاین و ئاسایشی سایبەری بە بەرزترین کوالێتی و کارایی پێشکەش دەکەین.",
    ctaPrimary: "پەیوەندیمان پێوە بکە",
    ctaSecondary: "پڕۆژەکانمان ببینە",
    cards: [
      { t: "ڕوانگەمان", d: "دابینکردنی ژێرخانێکی دیجیتاڵی بەهێز، پارێزراو و قابیلی گەشەکردن بۆ پڕۆژەکان هەر لە سەرەتاوە تاوەکو سەرکەوتن." },
      { t: "پەیاممان", d: "گۆڕینی بیرۆکەکان بۆ بەرهەمی ڕاستەقینە بە بەکارهێنانی باشترین بنەماکانی دیزاین و ئەندازیاری." },
      { t: "بەهاکانمان", d: "کوالێتی نایاب، ئاسایشی تۆکمە، ڕوونی لە کارکردن، و پشتگیری بەردەوام دوای ڕادەستکردنی پڕۆژە." },
    ],
    pillarsTitle: "ئەوەی پێشکەشی دەکەین",
    pillars: [
      { t: "ئاسایش لە بنچینەوە", d: "جێبەجێکردنی باشترین ڕێکارە ئەمنییەکان و بەهێزکردنی ئاسایشی پڕۆژە لە یەکەم ڕۆژەوە." },
      { t: "کارایی و خێرایی بەرز", d: "خێراکردنی بارکردن و وێنەکان، و باشترکردنی SEO، بەتایبەتی بۆ مۆبایل." },
      { t: "ڕادەستکردنی خاوێن", d: "کۆدی خاوێن و ڕێکخراو، لەگەڵ ڕێکخستنی دروستی فایلەکان بۆ ئاسانکردنی گۆڕانکارییەکانی داهاتوو." },
    ],
    statsTitle: "ئامارەکانمان",
    stats: [
      { k: "پڕۆژەکان", v: "10+", d: "وێبسایت و سیستەم" },
      { k: "باشترکردنی کارایی", v: "60%", d: "کەمکردنەوەی کاتی چاوەڕوانی" },
      { k: "پشتگیری", v: "24/7", d: "پشتگیری دوای ڕادەستکردن" },
    ],
    howTitle: "چۆن کار دەکەین؟",
    steps: [
      { t: "تێگەیشتن و لێکۆڵینەوە", d: "دیاریکردنی ئامانجەکان، بەکارهێنەران، و پێداویستییەکان بە وردی." },
      { t: "دیزاینی نایاب", d: "ڕووکاری Premium لەگەڵ ئەزموونێکی بەکارهێنەری ئاسان و مۆدێرن." },
      { t: "بونیادنانی پارێزراو", d: "بەکارھێنانی نوێترین تەکنەلۆژیاکان، بە خێرایی و SEOی بەهێزەوە." },
      { t: "دەستپێکردن و پشتگیری", d: "بڵاوکردنەوەی پڕۆژەکە، چاودێریکردن، و نوێکردنەوەی بەردەوام لەگەڵتدا." },
    ],
  },
} as const;
